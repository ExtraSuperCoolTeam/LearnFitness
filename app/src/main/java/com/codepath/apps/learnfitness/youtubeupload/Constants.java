...
package com.codepath.apps.learnfitness.youtubeupload;
...
public class Constants {
    ...
    public static final String UPLOAD_PLAYLIST = "PLc_XwVAYbWKEBLSgBGPLv-ZXbHVjeR-Ld";
    public static final String APP_NAME = "ytd-android";
    public static final String ACCOUNT_NAME = "securitytemp71@gmail.com";
}
